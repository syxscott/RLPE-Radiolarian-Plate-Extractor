...
import rlpe.evaluation.gold
import rlpe.evaluation.metrics
...
for slug in slugs:
    ...
    print(
        f"  {slug:20s} preds={len(paper_preds):3d} gold={len(gold_filtered):3d} | F1={f1:.3f} P={pp:.3f} R={rr:.3f} panel={pm:.3f}"
    )
