...
def test_dedup_panels_tie_keeps_first():
    ...
    panels = [
        {'paper_id': 'p1', 'figure_id': 'f1', 'panel_id': '1', 'species': 'A sp', 'confidence': 0.5, 'marker': 'first'},
        {'paper_id': 'p1', 'figure_id': 'f1', 'panel_id': '1', 'species': 'A sp', 'confidence': 0.5, 'marker': 'second'},
    ]
    deduped = dedup_panels(panels)
