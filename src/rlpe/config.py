...
_KNOWN_EXTRA_KEYS = {
    ...
    "MiniMax_api_key", "MiniMax_endpoint", "MiniMax_model",
    "MiniMax_max_concurrent", "MiniMax_timeout_sec",
    "MiniMax_max_retries", "MiniMax_enable_thinking",
    "MiniMax_thinking_budget_tokens", "MiniMax_max_output_tokens",
    "MiniMax_fallback_default", "MiniMax_interactive",
    ...
    "m3_enhanced_mode",
    "m3_stage_1", "m3_stage_2", "m3_stage_3", "m3_stage_4", "m3_stage_5",
    "m3_match_samples", "m3_diagnostic_dir",
    "m3_skip_match_on_empty_caption", "m3_retry_without_thinking",
    "m3_temperature", "m3_thinking_budget",
