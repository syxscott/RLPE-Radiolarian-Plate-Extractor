...
STRINGS = {
    ...
    "main.cancelled": "任务 {id} 已取消",
    "main.batch_exporting": "正在导出批处理 xlsx：{msg}",
    ...
    "restab.detail.cross_figure_link": "跨图关联",
    "restab.detail.ci": "置信区间",
    "restab.detail.image_verified": "图像已核对",
    "restab.detail.image_unverified": "图像未核对",
    "restab.detail.review_priority": "复核优先级",
    "restab.detail.scale_bar": "比例尺",
    "restab.detail.mark_verified": "✓  标记为已核对",
    "restab.detail.mark_unverified": "✗  标记为未核对",
    "restab.detail.verify_success": "已将 {n} 行标记为 {state}。",
    "restab.detail.verify_failed": "无法切换 image_verified：{error}",
    "restab.detail.no_selection": "请先在表格中选择一行。",
    ...
    "restab.detail.genus": "属",
    "restab.detail.sample_ids": "样品号",
    ...
    "runtab.label.caption_window.tooltip": "GROBID caption→page 查找窗口",
    ...
    "runtab.label.od_caption_window.tooltip": "OpenDataLoader caption↔image 跨页查找窗口",
    ...
    "runtab.error.invalid_pdf": "所选文件不是有效的 PDF。",
    "runtab.error.invalid_grobid_url": "GROBID 地址必须是有效的 http(s) URL。",
...
_src_dup = _re_dup.sub(
    r"\"\"\".*?\"\"\"", "", open(__file__, encoding="utf-8").read(), flags=_re_dup.S
)
